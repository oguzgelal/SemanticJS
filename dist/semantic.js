...
CORE_Export_exportOWL = function () {
...
CORE_Export_Export = function () {
  var Export = { exportOWL: CORE_Export_exportOWL };
  return Export;
}();
API_Semant = function () {
  function Semant() {
  ...
  Semant.prototype.Export = CORE_Export_Export;
  ...
  Semant.prototype.getVersion = function () {
    return SEMANTICS.version;
  };
  return Semant;
}();
(function (Semant) {
